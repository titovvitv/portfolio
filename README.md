...
- высоконагруженный проект в сфере customer relationship

Управление требованиями в процессах разработки ПО:
- сбор, формализация и согласование требований
- ведение документации по проектам
- участие в разработке архитектуры систем
- проектирование интеграций
- участие в процессах разработки и тестирования ПО


## NSYS group
- 2022 - 2023
- <a href="https://url.rw/?https%3A%2F%2Fnsysgroup.com" target="_blank">nsysgroup.com</a> (экосистема программных и аппаратных решений для индустрии б/у мобильных устройств)

### NSYS Inventory, NSYS BuyBack
> NSYS Inventory - система автоматизации процессов складского учёта, 
> NSYS BuyBack - система автоматизации процессов скупки
...
- Приведена в порядок документация по продуктам
...
## ORBL RUS
- 2019 - 2022
- <a href="https://orbl.io" target="_blank">orbl.io</a> (интегратор и разработчик ПО, поставщик серверного оборудования)
...
**Успехи**
- Интеграция технологии распознавания лиц в продукт ["Ростелеком Ключ"](https://key.rt.ru)
- Пилотные интеграции технологии распознавания лиц для ["X5 Group"](https://www.x5.ru)
- Реализован продукт Neuroio Security - интеграция технологии распознавания лиц в СКУД
- Интеграция Neuroio Security на предприятия компании ["Biocad"](https://biocad.ru)
- Интеграция Neuroio Security на предприятия компании ["Тринити"](https://www.trinitygroup.ru)

**Стек технологий**
- Код: Python, JS, Java/Kotlin
- БД: Postgress, MongoDB
- Интеграции: Rest, Soap, RabbitMQ
...
**Успехи**
- Разработка системы управления мероприятиями и системы online-продажи билетов для компании ["Expoforum"](https://expoforum-center.ru)
- Разработка системы управления рабочим временем для федеральной сети ["585 Золотой"](https://www.585zolotoy.ru)
